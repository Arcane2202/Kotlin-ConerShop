...
class PendingPackaging :AppCompatActivity(), PendingPackaginAdapter.ClickListener {

    private var layoutManager : RecyclerView.LayoutManager?=null
    private var adapter : RecyclerView.Adapter<PendingPackaginAdapter.PendingPackaginViewHolder>?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pending_packaging)
        ...
        reference = database.getReference("pending_orders")
        val FirebaseListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                child.forEach{
                   ...
                   // Toast.makeText(this@PendingPackaging,it.value.toString(),Toast.LENGTH_LONG).show()
                }
                adapter = PendingPackaginAdapter(itemlist,this@PendingPackaging, this@PendingPackaging)
